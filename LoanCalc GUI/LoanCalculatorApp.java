...
public class LoanCalculatorApp extends JApplet {
  ...
  private double interest = loanAmount / 100 / 12;
  private int payments = numYears * 12;
  
  public LoanCalculatorApp (double Rate, int NumYears, double LA) 
  {
  ...
  public double getMonthlyPayment() 
  {
    ...
    (Math.pow(1 / (1 + monthlyInterestRate), numYears * 12)));
  }
  ...
  public LoanCalculatorApp() {
    ...
    p1.setBorder(new
      TitledBorder("Enter interest rate, years, and loan amount"));
  ...
  private class ButtonListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      LoanCalculatorApp loan = new LoanCalculatorApp(interest, year, loanAmount);
